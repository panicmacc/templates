{
  description = "rust-mdbook project starter";
  ...
  outputs = { self, start, nixpkgs, nixpkgs-unstable, utils }@inputs:
    ...
    utils.lib.eachDefaultSystem (system:
      ...
      let
        ...
        #   They need to match the target architecture.
        ...
        # `nativeBuildInputs` is for build dependencies. 
        #   They need to match the build host architecture.
